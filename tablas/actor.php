...
if (isset($_GET['action']) && $_GET['action'] == 'delete' && isset($_GET['id'])) {
    ...
    try {
        // Llamada al endpoint para eliminar actor
        $response = $client->delete("actors/{$id}");
...
try {
    ...
    $response = $client->get('actors', $params);
                ...
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?php echo htmlspecialchars($actor['last_update']); ?></td>
                      <td>
                        <a href="actor_detalle.php?id=<?php echo $actor['id']; ?>" class="btn btn-info btn-sm">
                          <i class="fas fa-eye"></i>
                        </a>
                        <a href="javascript:void(0)" onclick="confirmarEliminar(<?php echo $actor['id']; ?>)" class="btn btn-danger btn-sm">
...
function confirmarEliminar(id) {
  if (confirm('¿Estás seguro de que deseas eliminar este actor? Esta acción no se puede deshacer.')) {
