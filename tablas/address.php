...
if (isset($_GET['action']) && $_GET['action'] == 'delete' && isset($_GET['id'])) {
    ...
    try {
        // Llamada al endpoint para eliminar dirección
        $response = $client->delete("addresses/{$id}");
...
try {
    ...
    $response = $client->get('addresses', $params);
...
<head>
    ...
    <title>Sakila DB | Direcciones</title>
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td><?php echo htmlspecialchars($direccion['address_id']); ?></td>
                      <td><?php echo htmlspecialchars($direccion['address']); ?></td>
                      <td><?php echo htmlspecialchars($direccion['address2'] ?? 'N/A'); ?></td>
                      <td><?php echo htmlspecialchars($direccion['district']); ?></td>
                      <td><?php echo htmlspecialchars($direccion['city_id']); ?></td>
                      <td><?php echo htmlspecialchars($direccion['postal_code'] ?? 'N/A'); ?></td>
                      <td><?php echo htmlspecialchars($direccion['phone']); ?></td>
                      <td><?php echo htmlspecialchars($direccion['last_update']); ?></td>
                      <td>
                        <a href="address_detalle.php?id=<?php echo $direccion['address_id']; ?>" class="btn btn-info btn-sm">
                          <i class="fas fa-eye"></i>
                        </a>
                        <a href="javascript:void(0)" onclick="confirmarEliminar(<?php echo $direccion['address_id']; ?>)" class="btn btn-danger btn-sm">
